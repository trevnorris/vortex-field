...
\item \textbf{Quantum sector (pointer):} The definition of $\psi$, conserved current, canonical algebra, and the Schr\"odinger/Pauli forms are developed in Sec.~\ref{sec:QM_projection}. Here we keep the framework axiomatic and defer all QM derivations and labels to that section.
\end{itemize}
