...
\begin{itemize}
    ...
    \item \textbf{Projection Scaling (P-1, P-3)}: Integration over slab thickness $\sim\xi$ in the extra dimension $w$ (P-1) shifts dimensions by one power of length, aligning 4D fields with 3D observables after rescaling (Section 2.3).
