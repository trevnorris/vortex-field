...
We now derive the wave equations for both sectors step-by-step from the postulates, addressing key challenges such as the linearized vorticity limitation and incorporating 4D projections to ensure self-consistency.
