...
\]
{\small\emph{Notation note:} here $\varepsilon_\rho$ denotes the geometric smallness $\xi/\ell$. When a density-contrast amplitude is needed in wave-sector derivations, we write it explicitly as $\delta\rho/\rho_0$.}
