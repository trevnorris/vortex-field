...
\subsection{Small Parameters and Regime of Validity}
...
\end{align}
% (surgical edit: added 1/c to both \eqref{eq:SEM-fixed} and \eqref{eq:Sint-fixed} to ensure [S]=[J·s] with x^0=ct)
