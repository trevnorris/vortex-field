...
from helper import (
    ...
    quick_verify, verify_conservation_law, verify_poisson_equation
)
import sympy as sp
...
v.section("4D TO 3D VELOCITY PROJECTION")
...
v.section("HELMHOLTZ DECOMPOSITION OF SLICE VELOCITY")
...
v.section("COULOMB GAUGE CONSTRAINT")
...
v.section("ELECTROMAGNETIC FIELD DEFINITIONS")
...
v.section("PHYSICAL INTERPRETATIONS FROM DOCUMENT")
...
v.section("GAUGE AND DECOMPOSITION PROPERTIES")
...
v.section("CONNECTION TO TRADITIONAL EM")
